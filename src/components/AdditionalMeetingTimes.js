...
export default function AdditionalMeetingTimes (props) {
    ...
    const add_meeting_type = props.add_meeting_type;
    const add_meeting_days = props.add_meeting_days;
    const add_meeting_start_time = props.add_meeting_start_time;
    const add_meeting_end_time = props.add_meeting_end_time;
    
    const add_meeting_key = props.add_meeting_key;
    
    const handleAddMeetingInfo = props.handleAddMeetingInfo;
    const deleteAddMeeting = props.deleteAddMeeting;
            ...
            <div class="radio-set">
				...
				<div class="form-group" >
                    <div class="custom-control custom-radio custom-control-inline">
                        ...
                        defaultChecked={add_meeting_type === "class"}
                    ...
                    <div class="custom-control custom-radio custom-control-inline">
                        ...
                        defaultChecked={add_meeting_type === "lab"}
                        onChange={handleAddMeetingInfo}
                        />
                    ...
                    <div class="custom-control custom-radio custom-control-inline">
                        ...
                        defaultChecked={add_meeting_type === "other"}
                        onChange={handleAddMeetingInfo}
                        />
			...
			<div class="radio-set">
				...
				<div class="form-group">
                    <div class="custom-control custom-checkbox custom-control-inline">
                        <input type="checkbox" class="custom-control-input" id={add_meeting_key + "add_meet-mon"} name="add_meeting_mon" value="monday"
                    ...
                    <div class="custom-control custom-checkbox custom-control-inline">
                        <input type="checkbox" class="custom-control-input" id={add_meeting_key + "add_meet-tues"} name="add_meeting_tues" value="tuesday"
                    ...
                    <div class="custom-control custom-checkbox custom-control-inline">
                        <input type="checkbox" class="custom-control-input" id={add_meeting_key + "add_meet-wed"} name="add_meeting_wed" value="wednesday"
                    ...
                    <div class="custom-control custom-checkbox custom-control-inline">
                        <input type="checkbox" class="custom-control-input" id={add_meeting_key + "add_meet-thurs"} name="add_meeting_thurs" value="thursday"
                    ...
                    <div class="custom-control custom-checkbox custom-control-inline">
                        <input type="checkbox" class="custom-control-input" id={add_meeting_key + "add_meet-fri"} name="add_meeting_fri" value="friday"
                    ...
                    <div class="custom-control custom-checkbox custom-control-inline">
                        <input type="checkbox" class="custom-control-input" id={add_meeting_key + "add_meet-sat"} name="add_meeting_sat" value="saturday"
                    ...
                    <div class="custom-control custom-checkbox custom-control-inline">
                        <input type="checkbox" class="custom-control-input" id={add_meeting_key + "add_meet-sun"} name="add_meeting_sun" value="sunday"
